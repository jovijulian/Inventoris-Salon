                                ...
                                <div class="box box-danger">
                                    ...
                                    <div class="box-body no-padding">
                                        <ul class="users-list clearfix">
                                            <li>
                                                <img src="<?php echo base_url()?>dist/img/user1-128x128.jpg"
                                                    alt="User Image">
                                                <a class="users-list-name" href="#">Alexander Pierce</a>
                                                <span class="users-list-date">Today</span>
                                            </li>
                                            <li>
                                                <img src="<?php echo base_url()?>dist/img/user8-128x128.jpg"
                                                    alt="User Image">
                                                <a class="users-list-name" href="#">Norman</a>
                                                <span class="users-list-date">Yesterday</span>
                                            </li>
                                            <li>
                                                <img src="<?php echo base_url()?>dist/img/user7-128x128.jpg"
                                                    alt="User Image">
                                                <a class="users-list-name" href="#">Jane</a>
                                                <span class="users-list-date">12 Jan</span>
                                            </li>
                                            <li>
                                                <img src="<?php echo base_url()?>dist/img/user6-128x128.jpg"
                                                    alt="User Image">
                                            ...
                                            <li>
                                                <img src="<?php echo base_url()?>dist/img/user5-128x128.jpg"
                                                    alt="User Image">
                                ...
                                <div class="table-responsive">
                                    <table class="table no-margin">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a
                                                        href="<?php echo base_url()?>pages/examples/invoice.html">OR9842</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a
                                                        href="<?php echo base_url()?>pages/examples/invoice.html">OR1848</a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a
                                                        href="<?php echo base_url()?>pages/examples/invoice.html">OR7429</a>
                                                </td>
                                                <td>iPhone 6 Plus</td>
                                ...
                                <ul class="products-list product-list-in-box">
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="<?php echo base_url()?>dist/img/default-50x50.gif"
                                                alt="Product Image">
                                        </div>
