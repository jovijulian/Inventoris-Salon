        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Tambah Penggunaan Barang</li>
                </ol>
            </section>
                            ...
                            <div class="box" style="width:105%;">
                                ...
                                <div class="container">
                                    <form action="<?=base_url('admin/proses_data_keluar')?>" role="form" method="post">
                                        ...
                                        <input type="hidden" name="id_barang" class="form-control" readonly="readonly"
                                            value="<?=$d->id_barang?>">
                                        ...
                                        <div class="form-group">
                                            <label for="tanggal">Tanggal
                                                Masuk</label>
                                            <input type="text" name="tanggal" class="form-control" readonly="readonly"
                                                value="<?=$d->tanggal?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="expire" class="form-control" required
                                                placeholder="Klik Disini"
                                                value="<?= set_value('expire', date('Y-m-d', strtotime($d->expire))); ?>"
                                                readonly>
                                        </div>
                                        <div class=" form-group">
                                            <label for="id_kategori">Kategori</label>
                                            <select class="form-control" name="id_kategori" required readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lokasi" class="form-control" readonly="readonly"
                                                value="<?=$d->lokasi?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_Barang">Nama Barang</label>
                                            <input type="text" name="nama_barang" class="form-control" id="nama_Barang"
                                                placeholder="Nama Barang" required value="<?=$d->nama_barang?>"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="suplier">Supplier</label>
                                            <select class="form-control" name="id_supplier" required readonly>
                                                <option value="<?=$d->id_supplier?>" selected=""><?=$d->nama?></option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="satuan">Satuan</label>
                                            <select class="form-control" name="id_satuan" required readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="jumlah" class="form-control" id="jumlah" required
                                                id="jumlah" max="<?=$d->jumlah?>" value="<?=$d->jumlah?>">
                                        </div>
                                        <?php } ?>
