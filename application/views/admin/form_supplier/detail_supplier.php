        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url('admin/detail_supplier')?>" class="active">Detail Supplier</a></li>
                </ol>
            </section>
                        ...
                        <div class="box" style="border-top-color: #e9decb">
                            <div class="box-body box-profile">
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="card-text" style="margin-top: 0%;"><?= $data_supplier[0]->nama ?></h2>
                                    <h4 class="card-title" style="margin-top: 2%;">Nomor Handphone</h4>

                                    <h2 class="card-text" style="margin-top: 0%;"><a
                                            href="https://wa.me/<?php echo $data_supplier[0]->no_hp?>/" target="_blank"
                                            data-toggle="tooltip"
                                            title="Connect to whatsapp!"><?= $data_supplier[0]->no_hp ?></a>
                                    </h2>
                                    <h4 class="card-title" style="margin-top: 2%;">Alamat</h4>
                                    <h2 class="card-text" style="margin-top: 0%;"><?= $data_supplier[0]->alamat ?></h2>
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active" style="border-top-color: #e9decb"><a href="#settings"
                                        data-toggle="tab">Barang Masuk</a></li>
                            </ul>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <?php if(is_array($detail_supplier)){ ?>
                                                    <?php $no = 1;?>
                                                    <?php foreach($detail_supplier as $dd): ?>
                                                    <td class="text-center"><?=$no?></td>
                                                    <td><?=$dd->kode_barang?></td>
                                                    <td><a href="<?=base_url('admin/detail_barang/'.$dd->id_barang)?>"
                                                            name="btn_update"
                                                            style="margin:auto;"><?= $dd->nama_barang ?></a></td>
                                                    <td><?=$dd->kode_kategori . ' / '. $dd->nama_kategori?></td>
                                                    <td><?=date('d-m-Y', strtotime($dd->tanggal))?></td>
