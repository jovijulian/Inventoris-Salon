                        ...
                        <div class="container">
                            ...
                            <div class="box" style="width:105%;">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Tambah
                                        Supplier</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <div class="container">
                                    <form action="<?=base_url('admin/proses_supplier_insert')?>" role="form"
                                        method="post">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat" id="alamat" cols="30" rows="10"
                                                    placeholder="Alamat" class="form-control" required></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="box-footer" style="width:100%;">
                                                ...
                                                <a type="button" class="btn"
                                                    ...
                                                    href="<?=base_url('admin/tabel_supplier')?>"
                                                    name="btn_listsupplier"><i class="fa fa-table"
                                                        aria-hidden="true"></i>
                                                    Lihat Supplier</a>
