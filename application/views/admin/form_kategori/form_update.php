                    ...
                    <div class="col-md-12">
                        <div class="container">
                            ...
                            <div class="box box-primary" style="width:105%;">
                                ...
                                <!-- form start -->
                                <div class="container">
                                    <form action="<?=base_url('admin/proses_kategori_update')?>" role="form"
                                        method="post">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="id" class="form-control" id="id"
                                                    placeholder="Kode Satuan" required value="<?=$d->id?>">
                                                <div class="form-group">
                                                    <label for="kode_kategori">Kode
                                                        Kategori</label>
                                                    <input type="text" name="kode_kategori" class="form-control"
                                                        id="kode_kategori" placeholder="Kode Satuan" required
                                                        value="<?=$d->kode_kategori?>">
                                                </div>
                                                <div class="form-group">
