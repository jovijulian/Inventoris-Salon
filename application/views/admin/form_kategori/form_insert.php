                    ...
                    <div class="col-md-12">
                        <div class="container">
                            ...
                            <div class="box" style="width:105%;">
                                ...
                                <!-- form start -->
                                <div class="container">
                                    <form action="<?=base_url('admin/proses_kategori_insert')?>" role="form"
                                        method="post">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_kategori" class="form-control"
                                                    id="kode_kategori" placeholder="Kode Kategori" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="box-footer" style="width:100%;">
                                                ...
                                                <a type="button" class="btn"
                                                    ...
                                                    href="<?=base_url('admin/tabel_kategori')?>"
                                                    name="btn_listkategori"><i class="fa fa-table"
                                                        aria-hidden="true"></i>
                                                    Lihat Kategori</a>
