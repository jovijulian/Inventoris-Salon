                    ...
                    <div class="col-md-12">
                        <div class="container">
                            ...
                            <div class="box" style="width:105%;">
                                ...
                                <!-- form start -->
                                <div class="container">
                                    <form action="<?=base_url('admin/proses_satuan_insert')?>" role="form"
                                        method="post">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_satuan" class="form-control"
                                                    id="nama_satuan" placeholder="Nama Satuan" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="box-footer" style="width:100%;">
                                                ...
                                                <a type="button" class="btn"
                                                    ...
                                                    href="<?=base_url('admin/tabel_satuan')?>" name="btn_listsatuan"><i
                                                        class="fa fa-table" aria-hidden="true"></i>
                                                    Lihat Satuan</a>
                                                <button type="submit" style="width:20%; background-color: #e9decb"
                                                    id="submit" class="btn"><i class="fa fa-check"
                                                        aria-hidden="true"></i>
                                                    Submit</button>
                                            </div>
                                            <!-- <div class="box-footer" style="width:93%;">
                                                ...
                                                <a type="button" class="btn btn-info" style="width:13%;margin-right:29%"
                                                    href="<?=base_url('admin/tabel_satuan')?>" name="btn_listsatuan"><i
                                                        class="fa fa-table" aria-hidden="true"></i> Lihat Satuan</a>
                                                <button type="submit" style="width:20%" class="btn btn-primary"><i
