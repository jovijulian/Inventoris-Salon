        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Tables</li>
                    <li class="active"><a href="<?=base_url('admin/tabel_barangmasuk')?>">Tabel Pembelian Barang</li>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Stok Pembelian
                                    Barang
                                </h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <a href="<?=base_url('admin/form_barangmasuk')?>"
                                    ...
                                    type="button" class="btn" name="tambah_data"><i class="fa fa-plus-circle"
                                        aria-hidden="true"></i> Tambah Data Pembelian
                                    Barang</a>
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p data-toggle="tooltip" title="<?= $dd->nama_kategori ?>">
                                                    <?= $dd->kode_kategori ?></p>
                                            </td>
                                            ...
                                            <td><a type="button" class="btn btn-success btn-barangkeluar"
                                                    ...
                                                    name="btn_barangkeluar" style="margin:auto;"><i
                                                        class="fa fa-sign-out" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $no++; ?>
                                        <?php endforeach;?>
                                        <?php }else { ?>
