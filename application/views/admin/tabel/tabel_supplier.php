                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Tabel Supplier
                                </h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <a href="<?=base_url('admin/form_supplier')?>"
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?=$no?></td>
                                            <td><a href="<?=base_url('admin/detail_supplier/'.$dd->id)?>"
                                                    name="btn_update" style="margin:auto;"><?= $dd->nama ?></a>
                                            </td>
                                            <td><?=$dd->no_hp?></td>
                                            <td><a type="button" class="btn btn-info"
                                                    href="<?=base_url('admin/update_supplier/'.$dd->id)?>"
                                                    name="btn_update" style="margin:auto;"><i class="fa fa-pencil"
                                                        aria-hidden="true"></i></a></td>
                                            <td><a type="button" class="btn btn-danger btn-delete"
                                                    href="<?=base_url('admin/delete_supplier/'.$dd->id)?>"
