...
<head>
    ...
    * {
    ...
    .login button .spinner {
        ...
        box-shadow: 0px 1px 0px #A4907C;
    }

    .login:not(.loading) button:hover {
        box-shadow: 0px 1px 3px #A4907C;
    }
...
<body>
    <div class="wrapper" style="background-image: url('<?php echo base_url("assets/images/bg-blur.JPEG"); ?>');">
        <form action="<?php echo base_url('login/proses_login')?>" class="login" method="post">

            <p class="title text-center"><i class="fa fa-sign-in" aria-hidden="true"></i> Log in</p>
