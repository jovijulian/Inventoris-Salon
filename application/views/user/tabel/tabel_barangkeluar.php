...
<div class="container text-center" style="margin: 2em auto;">
    <h2 class="tex-center">Report Penggunaan Barang</h2>
    ...
    <table class="table table-bordered table-striped" style="margin: 2em auto; display: none" id="tabel_barangkeluar">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <td id="kategori"></td>
            <td id="supplier"></td>
            <td id="jumlah" class="text-center"></td>
            <td id="satuan"></td>
            <td id="harga"></td>
            <td id="total"></td>
            <td id="expire"></td>
...
$(document).ready(function() {
    ...
    $("#bulanfilter").hide();
    $("#cardbayar").hide();
    $("#tabel_barangkeluar_wrapper").hide();
...
function prosesReset() {
    ...
    $("#tahun2").val('');
    $("#targetbayar").empty();
    $('#tabel_barangkeluar').DataTable().destroy();
    $("#tabel_barangkeluar").hide();
    $("#tabel_barangkeluar_wrapper").hide();
    $('#loader').hide();
...
function getDataTahun() {
    ...
    $('#loader').show();
    $.ajax({
        url: '<?=base_url('ReportUser/barangKeluarTahun')?>',
        type: 'POST',
        data: {
            tahun2: $("#tahun2").val(),
        },
        ...
        success: function(response) {
            $('#loader').hide();
            $("#tabel_barangkeluar").show();
            $("#tabel_barangkeluar_wrapper").show();
            $("#tabel_barangkeluar tbody").empty();
            ...
            $.each(response, function(index, item) {
                ...
                row.append($("<td>").text(item.tanggal_masuk));
                row.append($("<td>").text(item.tanggal_keluar));
                ...
                $("#tabel_barangkeluar tbody").append(row);
...
function getDataBulan() {
    ...
    $('#loader').show();
    $.ajax({
        url: '<?=base_url('ReportUser/barangKeluarBulan')?>',
        type: 'POST',
        data: {
            tahun1: $("#tahun1").val(),
...
function getDataTanggal() {
    ...
    $("#tabel_barangkeluar_wrapper").hide();
    $.ajax({
        url: '<?=base_url('ReportUser/barangKeluarTanggal')?>',
        type: 'POST',
        data: {
